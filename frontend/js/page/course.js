...
function addCourseHeader(course) {
    ...
    if (isUserRegistered) {
        ...
        const hasDiscount = (course.discount > 0) && (course.price > 0)
    ...
    courseHeaderCoverElm.innerHTML = `
        <img class="courses-header__video--image"
             src="../backend-v0.3.0/public/courses/covers/${course.cover}" alt="course">
    `
}
        ...
        courses.forEach(course => {
            ...
            relatedCourseElm.insertAdjacentHTML("beforeend", `
                <div class="course-related__card">
                    <img src="../backend-v0.3.0/public/courses/covers/${course.cover}" class="course-related__cars--image" alt="course">
