function blogCardRender(blogs, parentElmClasses, numberOfRender = blogs.length) {
    ...
    for (let i = 0; i < numberOfRender; i++) {
        const {title, description, cover} = blogs[i]
        ...
        newDivElm.innerHTML = `
                <div class="blog-card">
                    <div class="blog-card__banner">
                        <img class="blog-card__banner-image" src=${cover} alt="blog image">
                    </div>
                    <div class="blog-card__body">
                        <div class="blog-card__content">
                            <div class="blog-card__content--title">
                                <a class="blog-card__title--text" href="#">${title}</a>
                            </div>
                        ...
                        <div class="blog-card__show">
                            <a class="blog-card__show--link" href="#">
                                مطالعه مقاله
